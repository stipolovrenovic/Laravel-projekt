...
<head>
    ...
    <title>Laravel projekt - Prijava</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Dobrodošli natrag!</h1>
                                    </div>
                                    <form class="user" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            id="exampleInputPassword" placeholder="Lozinka">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                ...
                                                <label class="custom-control-label" for="customCheck">Zapamti me</label>
                                            </div>
                                        </div>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="{{ route('register') }}">Napravite račun!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
